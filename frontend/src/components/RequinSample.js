  ...
  try {
    const response = await axios.post(`${import.meta.env.backend_base_url}/sample/deleteFile/${fileId}`);
  ...
  try {
    const response = await axios.post(`${import.meta.env.backend_base_url}/sample/editFile/${fileId}`, updatedData);
