  ...
  try {
    const response = await axios.post(`http://localhost:5000/sample/deleteFile/${fileId}`);
  ...
  try {
    const response = await axios.post(`http://localhost:5000/sample/editFile/${fileId}`, updatedData);
